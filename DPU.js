...
const INSTAGRAM_BUSINESS_ACCOUNT_ID = process.env.INSTAGRAM_BUSINESS_ACCOUNT_ID || '17841445751381919';
const TABLE_NAME = process.env.TABLE_NAME || 'maharashtra_pune_dpu';
 ...
 */
async function postImagesToInstagramDPU_Supabase() {
  ...
  // Fixed maxPosts per run (removed dynamic distribution logic)
...
/**
 * Count confessions ready to be posted for College (accept=✓, is_posted!=✓, has imagekit_url)
 */
async function countReadyConfessionsDPU_Supabase() {
  try {
    ...
    console.log(`Error in countReadyConfessionsDPU_Supabase: ${e}`);
    return 0;
  }
}
...
module.exports = {
  postImagesToInstagramDPU_Supabase,
  countReadyConfessionsDPU_Supabase,
  testInstagramContentPublishingLimitDPU_Supabase
};
